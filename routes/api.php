...
Route::group([
    ...
    // Route::post('/website/spots/{id}', [SpotController::class, 'create']);
    Route::post('/vehicle', [VehicleController::class, 'search']);

    Route::get('/form/{key}', [FormConfiguratioController::class, 'get']);
     Route::post('/media', [MediaController::class, 'save']);
});
// Route::post('/medias', [MediaController::class, 'save']);
