...
export const RequestCancelByProfessionalScreen = memo(
  ({}: RequestCancelByProfessionalScreenProps) => {
    const { handleDeleteRequest, goBack, radioValues, setRadioValues } =
    ...
    return (
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.paragraphContainer}>
          ...
          <Text style={styles.paragraph}>
            Lorem ipsum dolor sit amet consectetur. Urna urna sed dui mattis ac
            ornare adipiscing
          </Text>
        ...
        <View style={styles.paragraphContainer}>
          ...
          <Text style={styles.paragraph}>
            ...
            turpis. Risus nulla nec purus at convallis diam. Vitae nulla aliquam
            vestibulum condimentum. Mauris dictum tincidunt placerat libero
            purus sed quis turpis viverra.
          </Text>
        </View>
