...
var UserRegister_1 = require("src/screens/UserRegister");
...
var HeaderGoBack_1 = require("@app/components/HeaderGoBack");
...
var FilterableSelect_1 = require("@app/screens/FilterableSelect");
    ...
    return (<>
      ...
      <native_1.NavigationContainer ref={function (navRef) {
        ...
        <Stack.Navigator initialRouteName="Tutorial">
          <Stack.Screen name="form-filterable-select" component={FilterableSelect_1.FilterableSelectScreen} options={{
            headerTitle: "",
          ...
          <Stack.Screen name="Register" component={UserRegister_1.UserRegisterScreen} options={{
            title: "Registrati",
            headerTitleAlign: "center",
            headerTitleStyle: {
                fontFamily: "HelveticaNeue-CondensedBlack",
