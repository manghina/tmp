...
const ImageIcon = ({ color, ...props }: ImageIconProps) => (
  <Svg width={24} height={24} fill="none" {...props}>
    <G fill={color ?? colorTokens.colorIcon}>
      <Path d="m2.58 19.01-.02.02c-.27-.59-.44-1.26-.51-2 .07.73.26 1.39.53 1.98ZM9 10.38a2.38 2.38 0 1 0 0-4.76 2.38 2.38 0 0 0 0 4.76Z" />
